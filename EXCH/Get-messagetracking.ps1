...
$msxserver = (Get-Recipient $fulladdr |select -ExpandProperty ServerName)+".degroof.be"
$suffix = "@degroofpetercam.com"
...
$objLabel1.Text = "Enter the email address to track,sans suffix;"
